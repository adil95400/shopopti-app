/*
  ...
  1. New Tables
    - `templates` - Stores templates for various content types
      - `id` (uuid, primary key)
      - `name` (text, required)
      - `description` (text, optional)
      - `type` (text, required, enum: 'product', 'landing', 'email', 'blog', 'social')
  ...
  2. Security
    ...
    - Add policies for public read access to public templates
