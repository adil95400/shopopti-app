          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
                Créez votre boutique dropshipping en <span className="text-primary-500">2 minutes</span>
              </h1>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div className="text-center">
              <p className="text-4xl font-bold text-primary-500">1,8M+</p>
              <p className="mt-2 text-gray-600">Dropshippers utilisent Shopopti+</p>
            </div>
            <div className="text-center">
              <p className="text-4xl font-bold text-primary-500">1 Md$+</p>
              <p className="mt-2 text-gray-600">Gagné par nos dropshippers</p>
            </div>
            <div className="text-center">
              <p className="text-4xl font-bold text-primary-500">800M+</p>
              <p className="mt-2 text-gray-600">Produits gagnants disponibles</p>
            </div>
            <div className="text-center">
              <p className="text-4xl font-bold text-primary-500">24/7</p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-3">
            <div className="bg-white p-8 rounded-xl shadow-sm">
              <div className="rounded-lg bg-primary-100 p-3 w-12 h-12 flex items-center justify-center mb-6">
              ...
              <Link to="/register" className="text-primary-600 font-medium flex items-center">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Réalisé par AutoDS</h3>
              <p className="text-gray-600 mb-4">
      ...
      <section className="py-20 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-center space-x-4 mb-12">
            <Link to="/register" className="btn btn-outline border-primary-500 text-primary-500 hover:bg-primary-50">
              Commencez à vendre
            </Link>
          ...
          <div className="bg-gradient-to-r from-blue-900 to-indigo-900 rounded-2xl overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="p-8 md:p-12">
                ...
                <div className="mt-8">
                  <Link to="/register" className="btn bg-red-500 hover:bg-red-600 text-white">
